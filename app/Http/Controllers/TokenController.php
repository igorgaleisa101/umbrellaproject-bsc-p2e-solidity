...
class TokenController extends Controller
{
    ...
    public function getCratePreset(Request $request) 
    {
        ...
        $preset = Preset::where('tokentype_id', 2)->where('special', false)->where('is_deleted', false)->where('faction_id', $crate_faction)->whereIn('rarity_id', $crate_rarities)->get()->pluck('preset_id')->toArray();
